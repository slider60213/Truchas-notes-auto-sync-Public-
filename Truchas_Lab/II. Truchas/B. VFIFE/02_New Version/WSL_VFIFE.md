...
### **舊版 VFIFE 內容：**
- [Data_save_module_F90](../01_Old%20Version/程式碼/Data_save_module_F90.md)
- [SOLID_module_F90](../01_Old%20Version/程式碼/SOLID_module_F90.md)
- [moving_rigid_module_F90](../01_Old%20Version/程式碼/moving_rigid_module_F90.md)
...
### **2. dat 檔讀取**
- 原版參數宣告：[Data_save_module_F90](../01_Old%20Version/程式碼/Data_save_module_F90.md)  
- 原版參數讀取：[SOLID_module_F90](../01_Old%20Version/程式碼/SOLID_module_F90.md)  
[Data_save_module_F90](../01_Old%20Version/程式碼/Data_save_module_F90.md) + [SOLID_module_F90](../01_Old%20Version/程式碼/SOLID_module_F90.md)  :LiArrowRight:  [VFIFE_FSI_module.F90](VFIFE_FSI_module.F90.md)  
...
### **3. 3D 建模**
針對不同模擬案例需要配置對應的 dat 檔（<font color="#ffff00">節點座標</font>、<font color="#ffff00">四面體節點構成</font>），[可使用的軟體](../00_AI%20CHAT/Gemini/Gemini_免費建模軟體比較與建議/chat_免費建模軟體比較與建議.md) 中以 [Gmsh](Gmsh.md) 最為適配，原因主要有：
- 2026/03 仍持續更新
- 兼具 Windows 版與 Linux 版
- 腳本操作適配 AI 工具
過往最大的難點在於 UI 選項龐雜操作難用，但如今透過 AI 工具可輕鬆完成建模腳本，大幅提升建模速度與精細度，UI 則作為檢視器來預覽成果，雙版本也完美適配 [WSL2](../../C.%20Truchsa-WSL/01_WSL%20&%20LXD/01_WSL/WSL2.md) 的工作環境。
### **4. 物理計算**
<mark style="background:#ff4d4f">待修正 </mark>
[VSlider (新版VFIFE)](程式碼/VSlider%20(新版VFIFE).md)
### **5. 模擬**
<mark style="background:#ff4d4f">待修正</mark>
