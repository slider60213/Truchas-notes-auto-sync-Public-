...
* 隨著 [WSL](../../02_WSL_Ubuntu/02_WSL與LXD/01_WSL/WSL.md) 更新， Gmsh搭配的 python版本可能與系統有所差異，因此使用 [venv](../../02_WSL_Ubuntu/01_116版_2.0.2/pics/LXD_Docker_.venv.md) (Virtual Environment) 來作隔離，操作 Gmsh 前須在 WSL狀態輸入指令切換至 venv身份。
...
- **開始操作前，在 [WSL](../../02_WSL_Ubuntu/02_WSL與LXD/01_WSL/WSL.md) 狀態下輸入 `venv` 來切換成 venv 身份。**
- **開始操作前，在 [WSL](../../02_WSL_Ubuntu/02_WSL與LXD/01_WSL/WSL.md) 狀態下輸入 `venv` 來切換成 venv 身份。**
- **開始操作前，在 [WSL](../../02_WSL_Ubuntu/02_WSL與LXD/01_WSL/WSL.md) 狀態下輸入 `venv` 來切換成 venv 身份。**
